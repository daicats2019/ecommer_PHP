                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            @foreach($contact_footer as $key => $contac)
                            <a href="{{url('/')}}"><img src="{{('public/uploads/contact/'.$contac->info_logo)}}" width="100%" alt="" /></a>
                            @endforeach
                        </div>
                        <div class="btn-group pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{url('lang/cn')}}">Chinese</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            ...
                            <ul class="nav navbar-nav">
                               ...
                               <!--  <li><a href="{{URL::to('/yeu-thich')}}"><i class="fa fa-star"></i> Like</a></li> -->
                                <li><a href="#"><i class="fa fa-star"></i> Like</a></li>
                                <?php
                                ...
                                ?>
                                 <li><a href="{{URL::to('/log-in')}}"><i class="fa fa-crosshairs"></i> Payment</a></li>
                                <?php
                                 }
                                ?>
                                ...
                                if($customer_id!=NULL){ 
                                   ...
                                   ?>
                                   <li><a href="{{URL::to('/log-in')}}"><i class="fa fa-lock"></i> Login</a></li>
                                   <?php 
                               }
                               ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box">
                            ...
                            <input type="text" style="width: 60%;margin-right: 5px" name="keywords_submit" id="keywords" placeholder="Search product"/>
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="doitac">Our partner</h3>
        ...
        <div class="footer-widget">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="single-widget">
                            <h2>Shop address information</h2>
                    ...
                    <div class="col-sm-3 col-sm-offset-1">
                        <div class="single-widget">
                            ...
                            <form action="#" class="searchform">
                                ...
                                <p>Our shop has the latest updates <br />we will remind you by email.</p>
                            </form>
                        </div>
                    </div>
...
// Brand
    ...
    <script>
      ...
      paypal.Button.render({
        ...
        client: {
          sandbox: 'AfVH3ps9EgRJfr2qDwBLNGLQhJwnbGQpO6dK6a_GnlOB2IavDn5SsmVguE4GkbWYcOmsnSjVJK0W1C8v',
        ...
        onAuthorize: function(data, actions) {
          return actions.payment.execute().then(function() {
            ...
            window.alert('Thank you for purchasing from us!');
          });
        }
      }, '#paypal-button');
  ...
  <!-- Messenger Plugin chat Code -->
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "122779846657528");
	  ...
	  theme_color="#0A7CFF"
	  logged_in_greeting="Hello, how can the shop help you?"
	  logged_out_greeting="Hello, how can the shop help you?">
      </div>
	<script type="text/javascript">
...
<script type="text/javascript">
   ...
   sosanh();
                ...
                var id = data[i].id;
                 ...
                 $('#row_compare').find('tbody').append(`
                                                         <tr id="row_compare`+id+`">
                                                            ...
                                                            <td></td>
                                                            <td><a href="`+url+`">View products</a></td>
                                                            <td><a style="cursor:pointer" onclick="delete_compare(`+id+`)">Clear comparison</a></td>
                                                          </tr>
    ...
    function add_compare(product_id){
        // document.getElementById('title-compare').innerText = 'Only up to 4 products can be compared';
        var id = product_id;
...
<script type="text/javascript">
    ...
    function viewed(){
         ...
         if(localStorage.getItem('viewed')!=null){
             ...
             for(i=0;i<data.length;i++){
                ...
                $('#row_viewed').append('<div class="row" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="'+image+'"></div><div class="col-md-8 info_wishlist"><p>'+name+'</p><p style="color:#FE980F">'+price+'</p><a href="'+url+'">Watch now</a></div>');
            }
    ...
    function product_viewed(){
        ...
        var id =  document.getElementById('viewed_productid').value;
        alert(id);
            ...
            if(matches.length){
               ...
               $('#row_viewed').append('<div class="row" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="'+newItem.image+'"></div><div class="col-md-8 info_wishlist"><p>'+newItem.name+'</p><p style="color:#FE980F">'+newItem.price+'</p><a href="'+newItem.url+'">Order</a></div>');
...
<script type="text/javascript">
     ...
     function view(){
         ...
         if(localStorage.getItem('data')!=null){
             ...
             for(i=0;i<data.length;i++){
                ...
                $('#row_wishlist').append('<div class="row" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="'+image+'"></div><div class="col-md-8 info_wishlist"><p>'+name+'</p><p style="color:#FE980F">'+price+'</p><a href="'+url+'">Order</a></div>');
            }
   ...
   function add_wistlist(clicked_id){
        ...
        if(matches.length){
            alert('Products you already love, so can not add');

        }else{

            old_data.push(newItem);

           $('#row_wishlist').append('<div class="row" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="'+newItem.image+'"></div><div class="col-md-8 info_wishlist"><p>'+newItem.name+'</p><p style="color:#FE980F">'+newItem.price+'</p><a href="'+newItem.url+'">Order</a></div>');
    ...
    $(document).on('click', '.rating', function(){
          ...
          $.ajax({
           ...
           success:function(data)
           {
            if(data == 'done')
            {
             alert("You have rated "+index +" trên 5");
            }
            else
            {
             alert("Rating error");
        ...
        $('.send-comment').click(function(){
            ...
            $.ajax({
              ...
              success:function(data){
                ...
                $('#notify_comment').html('<span class="text text-success">Comment added successfully, comment is pending approval</span>');
                load_comment();
          ...
          var total_after = $('.total_after').val();
                ...
                function(isConfirm){
                     if (isConfirm) {
                        ...
                        swal("Close", "Order has not been sent, please complete the order", "error");
        ...
        $(document).ready(function(){
            ...
            $('.add-to-cart').click(function(){
                ...
                if(parseInt(cart_product_qty)>parseInt(cart_product_quantity)){
                    alert('Please order smaller ' + cart_product_quantity);
                }else{
         ...
         function DeleteItemCart($session_id){
            ...
            $.ajax({
                        ...
                        success:function(){
                            ...
                            $('.show_quick_cart_alert').append('<p class="text text-success">Product removed from cart successfully.</p>');
                            setTimeout(function() {
            ...
            $(document).on('click','.add-to-cart-quickview',function(){
                ...
                if(parseInt(cart_product_qty)>parseInt(cart_product_quantity)){
                    ...
                    $.ajax({
                        ...
                        data:{cart_product_id:cart_product_id,cart_product_name:cart_product_name,cart_product_image:cart_product_image,cart_product_price:cart_product_price,cart_product_qty:cart_product_qty,_token:_token,cart_product_quantity:cart_product_quantity},
                        beforeSend: function(){
                            $("#beforesend_quickview").html("<p class='text text-primary'>Adding products to cart</p>");
                        },
                        success:function(){
                            $("#beforesend_quickview").html("<p class='text text-success'>Product added to cart</p>");
