      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            ...
            <th>Name of article category</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Are you sure you want to delete this post?')" href="{{URL::to('/delete-category-post/'.$cate_post->cate_post_id)}}" class="active styling-edit" ui-toggle-class="">
