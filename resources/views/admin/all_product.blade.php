        ...
        <tbody>
          ...
          <tr>
            ...
            @if($pro->product_file)
              ...
              @endphp
              @if($extension=='pdf')
              <td><a target="_blank" href="{{asset('public/uploads/document/'.$pro->product_file)}}">View file</a></td>
              @elseif($extension=='docx')
              <td><a target="_blank" href="https://view.officeapps.live.com/op/view.aspx?src={{ url('public/uploads/document/'.$pro->product_file) }}">View file</a></td>
              @endif
            @else 
            <td>No file</td>
            @endif
