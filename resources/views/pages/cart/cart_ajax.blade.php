	...
	<section id="cart_items">
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
				  <li><a href="{{URL::to('/')}}">Homa page</a></li>
						...
						<tr>
							...
							<td>
								@if(Session::get('customer_id'))
	                          	...
	                          	@else 
	                          	<a class="btn btn-default check_out" href="{{url('/log-in')}}">Order</a>
								@endif
							</td>
									...
									@foreach(Session::get('coupon') as $key => $cou)
										@if($cou['coupon_condition']==1)
											...
											<p>
												...
												echo '<p><li>Total reduction:'.number_format($total_coupon,0,',','.').'đ</li></p>';
												@endphp
											</p>
											<p><li>Total has decreased :{{number_format($total-$total_coupon,0,',','.')}}đ</li></p>
										@elseif($cou['coupon_condition']==2)
											...
											<p><li>Total has decreased :{{number_format($total_coupon,0,',','.')}}đ</li></p>
										@endif
									@endforeach
