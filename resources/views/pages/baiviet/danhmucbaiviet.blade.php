...
<div class="features_items">
                        ...
                        <div class="zalo-share-button" data-href="{{$url_canonical}}" data-oaid="1935630054234624247" data-layout="1" data-color="blue" data-customize=false></div>
                            ...
                            @foreach($post_cate as $key => $p)
                                <div class="single-products" style="margin:10px 0;padding: 2px">
                                        ...
                                        <div class="text-right">
                                    		<a  href="{{url('/bai-viet/'.$p->post_slug)}}" class="btn btn-default btn-sm">View Posts</a>
                                    	</div>
                                </div>
