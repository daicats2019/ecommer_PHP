...
<div class="features_items"><!--features_items-->
                       <div class="fb-share-button" data-href="http://furniture.com/Shopbanhang" data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{$url_canonical}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
                       <div class="fb-like" data-href="{{$url_canonical}}" data-width="" data-layout="button_count" data-action="like" data-size="small" data-share="false"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <label for="amount">Filter categories</label>
                                    ...
                                    <label class="checkbox-inline">
                                       <input  type="checkbox"
                                        class="form-control-checkbox category-filter" data-filters="category" value="{{$cate->category_id}}" name="category-filter" 

                                        {{ in_array($cate->category_id, $category_arr) ? 'checked' : ''}} >{{$cate->category_name}}
