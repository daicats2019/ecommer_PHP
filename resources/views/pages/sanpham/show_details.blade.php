...
<!-- so sánh , like, xem nhanh -->
	<input type="hidden" id="viewed_productid" value="{{$value->product_id}}">
	...
	<!--product-details-->
						...
						<nav aria-label="breadcrumb">
						  <ol class="breadcrumb"  style="background: none;">
						    ...
						    <li> <div class="fb-share-button" data-href="{{$url_canonical}}" data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{$url_canonical}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></li>
						  </ol>
						</nav>
						...
						<div class="col-sm-7">
							...
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Conditions:</b> 100% New</p>
								<p><b>Number of stock left:</b> {{$value->product_quantity}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#reviews" data-toggle="tab">Evaluate</a></li>
							</ul>
						</div>
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										<span>
											<input style="width:100%;margin-left: 0" type="text" class="comment_name" placeholder="Comment name"/>
