...
class AdminController extends Controller
{
    ...
    public function callback_customer_google(){
        ...
        return redirect('/log-in')->with('message', 'Sign in with google account <span style="color:red">'.$account_name->customer_email.'</span> success');  
    }
    ...
    public function callback_facebook_customer(){
        ...
        if($account!=NULL){
           ...
           return redirect('/log-in')->with('message', 'Login with facebook account <span style="color:red">'.$account_name->customer_email.'</span> success');  
        ...
        return redirect('/log-in')->with('message', 'Login with facebook account <span style="color:red">'.$account_new->customer_email.'</span> success');      
