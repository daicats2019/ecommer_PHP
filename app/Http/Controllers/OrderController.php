...
class OrderController extends Controller
{
	...
	public function update_order_qty(Request $request){
		...
		$title_mail = "Order placed is confirmed".' '.$now;
	...
	public function print_order_convert($checkout_code){
		...
		<h1><center> Company Shop Furniture</center></h1>
		...
		<th>Sdt</th>
		<th>Email</th>
		<th>Note</th>th>Recipient Name</th>
		<th>Address</th>
		<th>Sdt</th>
		<th>Email</th>
		<th>Notes</th>
		...
		<p>Payment: '.number_format($total_coupon + $product->product_feeship,0,',','.').'đ'.'</p>
		</td>
		</tr>';
		$output.='				
		</tbody>
	...
	public function history(Request $request){
		if(!Session::get('customer_id')){
			return redirect('log-in')->with('error','Please login to view purchase history');
		}else{
