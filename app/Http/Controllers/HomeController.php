...
class HomeController extends Controller
{
    ...
    public function load_more_product(Request $request){
        ...
        if(!$all_product->isEmpty()){
            foreach($all_product as $key => $pro){
                ...
                <button class="btn btn-default home_cart_'.$pro->product_id.'" id="'.$pro->product_id.'" onclick="Addtocart(this.id);"><i class="fa fa-shopping-cart"></i>Add to cart</button>

                <button style="display:none" class="btn btn-danger rm_home_cart_'.$pro->product_id.'" id="'.$pro->product_id.'" onclick="Deletecart(this.id);"><i class="fa fa-shopping-cart"></i>Quit added</button>


                <input type="button" data-toggle="modal" data-target="#xemnhanh" onclick="XemNhanh(this.id);"  value="Quick view"  class="btn btn-default" id="'.$pro->product_id.'" name="add-to-cart">
                ...
                <button class="button_wishlist" id="'.$pro->product_id.'" onclick="add_wistlist(this.id);"><span>Like</span></button>

                </li>

                 <li ><a style="cursor: pointer;" onclick="add_compare('.$pro->product_id.')" ><i class="fa fa-plus-square"></i>Compare</a></li>
             ...
             $output .= '
                <div id="load_more">
                    <button type="button" name="load_more_button" class="btn btn-primary form-control" data-id="'.$last_id.'" id="load_more_button">Load more products
                    </button>
                </div>
            ';
        }else{
            $output .= '
                <div id="load_more">
                    <button type="button" name="load_more_button" class="btn btn-default form-control">Data is being updated...
                    </button>
                </div>
            ';
        }
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Specializes in selling accessories and furniture"; 
        $meta_keywords = "Household furniture";
        $meta_title = "Genuine accessories and furniture";
