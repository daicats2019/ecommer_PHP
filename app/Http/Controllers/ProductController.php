...
class ProductController extends Controller
{
   ...
   public function file_browser(Request $request){
    ...
    public function quickview(Request $request){
        ...
        $output['product_button'] = '<input type="button" value="Buy now" class="btn btn-primary btn-sm add-to-cart-quickview" id="buy_quickview" data-id_product="'.$product->product_id.'"  name="add-to-cart">';
    ...
    public function active_product($product_id){
        ...
        Session::put('message','Product activation successful');
        return Redirect::to('all-product');
    }
    ...
    public function tag(Request $request, $product_tag){
        ...
        $meta_desc = 'Search Tags::'.$product_tag;
        $meta_keywords = 'Search Tags:'.$product_tag;
        $meta_title = 'Search Tags:'.$product_tag;
        $url_canonical = $request->url();
