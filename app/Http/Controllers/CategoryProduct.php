...
class CategoryProduct extends Controller
{
    ...
    public function unactive_category_product($category_product_id){
        ...
        Session::put('message','Product catalog not activated successfully');
        return Redirect::to('all-category-product');
    ...
    public function active_category_product($category_product_id){
        ...
        Session::put('message','Product catalog activation successful');
        return Redirect::to('all-category-product');
    }
    ...
    public function update_category_product(Request $request,$category_product_id){
        ...
        Session::put('message','Product catalog update successfully');
        return Redirect::to('all-category-product');
    }
    ...
    $category_by_id = Product::with('category')->whereIn('category_id',$category_arr)->orderBy('product_id','DESC')->paginate(8)->appends(request()->query());
    ...
    if($product_count>0){
        ...
        foreach($product as $key => $val) {          
            ...
            <p>'.$val->product_name.'</p>
                ...
                <button class="btn btn-default" id="'.$val->product_id.'" onclick="Addtocart(this.id);"><i class="fa fa-shopping-cart"></i>Add to cart</button>
            </div>
       ...
       <p style="color:red;text-align:center;">There are currently no products in this category</p>
       </div>
