...
class VideoController extends Controller
{
    		...
    		foreach($video as $key => $vid){
    			...
    			$output.='
    				 ...
    				 <td>'.$i.'</td>
			           ...
			           <td><button type="button" data-video_id="'.$vid->video_id.'"  class="btn btn-xs btn-danger btn-delete-video">Delete video</button></td>
			         </tr>
    ...
    public function video_shop(Request $request){
        ...
        //seo 
        $meta_desc = "Shop company video"; 
        $meta_keywords = "Household furniture";
        $meta_title = "Videos Shop";
